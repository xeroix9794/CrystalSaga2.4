...
static REAL bands[] = {
  (REAL)65.406392,(REAL)92.498606,(REAL)130.81278,(REAL)184.99721,(REAL)261.62557,(REAL)369.99442,(REAL)523.25113,
  (REAL)739.9884 ,(REAL)1046.5023,(REAL)1479.9768,(REAL)2093.0045,(REAL)2959.9536,(REAL)4186.0091,(REAL)5919.9072,
  (REAL)8372.0181,(REAL)11839.814,(REAL)16744.036
};
...
void equ_makeTable(REAL *lbc,REAL *rbc,paramlist *param,REAL fs)
{
  ...
  for(i=0;i<winlen;i++)
	...
	irest[i] =hn(i-winlen/2,param2,fs)*win((REAL)(i-winlen/2),winlen);
