...
public:
    ...
    void PlayPose( const drPlayPoseInfo* info );
    void PlayPosePause();
	...
	HRESULT GetObjDummyRunTimeMatrix(drMatrix44* mat, DWORD dummy_id,int type = -1);
    ...
    drPoseInfo* GetPoseInfo(DWORD pose_id);
    drPoseInfo* GetPoseInfoBig(DWORD big_pose_id);
...
inline HRESULT CCharacterModel::GetObjDummyRunTimeMatrix(drMatrix44* mat, DWORD dummy_id, int type)
{
