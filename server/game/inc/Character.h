...
class CCharacter : public CMoveAble
{
	...
	struct GuildsList {
		vector<int>* guildID = new vector<int>();
		vector<GuildMember>* Members = new vector<GuildMember>();
	};
...
public:
	...
	// 指令函数
	GuildsList* Guilds = new GuildsList();
