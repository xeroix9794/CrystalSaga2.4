...
public:
	...
	void			SetName(dbc::cChar *cszName) {/*strncpy(m_name, cszName, defENTITY_NAME_LEN - 1);*/strncpy_s(m_name, sizeof(m_name), cszName, _TRUNCATE); m_name[defENTITY_NAME_LEN -1] = '\0';}
	const char*     GetName() { return m_name; }
	const char*     GetLogName() { return m_CLog.GetLogName(); }
	void			SetBirthCity(dbc::cChar *cszName) {/*strncpy(m_szBirthCity, cszName, MAX_MAPNAME_LENGTH - 1);*/strncpy_s(m_szBirthCity, sizeof(m_szBirthCity),cszName, _TRUNCATE); m_szBirthCity[MAX_MAPNAME_LENGTH -1] = '\0';}
	const char*     GetBirthCity() { return m_szBirthCity; }
	void			SetBirthMap(dbc::cChar *cszName) {/*strncpy(m_szBirthMap, cszName, MAX_MAPNAME_LENGTH - 1)*/strncpy_s( m_szBirthMap, sizeof(m_szBirthMap), cszName, _TRUNCATE ); m_szBirthMap[MAX_MAPNAME_LENGTH -1] = '\0';}
