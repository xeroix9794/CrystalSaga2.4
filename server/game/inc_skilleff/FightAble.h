...
public:
	...
	void	WriteSkillStateMore(WPACKET &pk);//Add by sunny.sun 20090731 for 为队伍添加状态
	...
	virtual bool	AddSkillState(dbc::uChar uchFightID, dbc::uLong ulSrcWorldID, dbc::Long lSrcHandle, dbc::Char chObjType, dbc::Char chObjHabitat, dbc::Char chEffType,
					dbc::uShort uchStateID, dbc::uChar uchStateLv, dbc::Long lOnTick, dbc::Char chType = enumSSTATE_ADD_UNDEFINED, bool bNotice = true){return false;}
	
#ifdef COMPACT_MEM_2
	virtual bool	DelSkillState(map<unsigned char, SSkillStateUnit>::iterator& pUnit, bool bNotice = true){return false;}
#endif
	virtual bool	DelSkillState(dbc::uShort uchStateID, bool bNotice = true){return false;}
