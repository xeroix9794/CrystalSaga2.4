...
public:
	...
	BOOL    Init(LPDIRECT3DDEVICE8	pDev)
	{
		...
		mi.vertex_seq[0] = drVector3(-frad, -frad,  0.000001f);
		mi.vertex_seq[1] = drVector3(frad, -frad,   0.000001f);
		mi.vertex_seq[2] = drVector3(frad, frad,    0.000001f);
		mi.vertex_seq[3] = drVector3(-frad, frad,   0.000001f);
