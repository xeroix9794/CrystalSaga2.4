...
#ifdef __SKY__
	string GetSceneMapFile() const { return _stInit.strMapFile; }
#endif
...
public:
	...
	void			SetupVertexFog(drIDeviceObject* dev_obj, float Start, float End, DWORD Color, DWORD Mode, BOOL UseRange, FLOAT Density);
...
public:
    ...
    int             GetMainChaPickRay(drVector3* org, drVector3* ray);
