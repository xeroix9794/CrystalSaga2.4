...
extern void NetPC_GUILD_PERM(uLong chaid, uLong permission);
...
extern void NetMC_GUILD_INFO( DWORD dwCharID, DWORD dwGuildID, const char szGuildName[], const char szGuildMotto[], DWORD color = -1 );
...
extern BOOL PC_GUILDATTR_UPDATE(LPRPACKET pk);
extern BOOL	PC_GUILD_INVITE(LPRPACKET pk);
extern BOOL	PC_GUILD_CANCEL(LPRPACKET pk);
extern BOOL PC_GUILD_PERMISSIONS(LPRPACKET pk);