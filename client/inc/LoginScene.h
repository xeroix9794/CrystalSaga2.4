...
public:	
	...
	static void SetAccount(int accountNumber);
...
private:
	...
	void SaveUserName(CCheckBox& chkID, CEdit& edtID, CEdit& edtPassword);
	void SavePassword(CCheckBox& chkID, CEdit& edtPassword);
