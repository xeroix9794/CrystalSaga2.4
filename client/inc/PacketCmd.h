...
extern BOOL SC_SYNCCHAR(LPRPACKET pk);
...
extern BOOL SC_SynAppendEquip(LPRPACKET packet);
...
extern BOOL SC_GetNameColor(LPRPACKET pk);
...
extern void ReadChaAppendEquip(LPRPACKET pk, stNetAppendLook& append);
...
// FEATURE: GUILD_BANK
extern BOOL SC_UpdateGuildBankGold(LPRPACKET pk);
