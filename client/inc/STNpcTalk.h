...
class CAdmiralState : public CActionState
{
public:
	CAdmiralState(CActor* p);
	virtual const char* GetExplain() { return "CAdmiralState"; }
	virtual void Cancel() {}
	virtual void MouseRightDown() { PopState(); }

	void	SetAdmiralGridID(int n) { _nAdmiralGridID = n; }
	int		GetAdmiralGridID() { return _nAdmiralGridID; }
