...
int UI_SetLabelExFont( int id, int nFontIndex, int IsShadow, DWORD dwShadowColor )
{
...
int UI_SetTitleFont( int id, int nFontIndex, DWORD color, int h )
{
...
int UI_CreateTextItem( const char* text, DWORD color )
{
...
void MPInitLua_Gui()
{
	...
	CLU_RegisterFunction("UI_ComboSetTextColor", "int", "int, ulint", CLU_CDECL, CLU_CAST(UI_ComboSetTextColor));
	...
	CLU_RegisterFunction("UI_SetListFontColor", "int", "int, ulint, ulint", CLU_CDECL, CLU_CAST(UI_SetListFontColor));
	...
	CLU_RegisterFunction("UI_SetChatColor", "int", "ulint, ulint, ulint, ulint, ulint, ulint, ulint, ulint", CLU_CDECL, CLU_CAST(UI_SetChatColor));
	...
	CLU_RegisterFunction("UI_SetEditCursorColor", "int", "int, ulint", CLU_CDECL, CLU_CAST(UI_SetEditCursorColor));
	...
	CLU_RegisterFunction("UI_SetTextColor", "int", "int, ulint", CLU_CDECL, CLU_CAST(UI_SetTextColor));
	...
	CLU_RegisterFunction("UI_SetLabelExShadowColor", "int", "int, ulint", CLU_CDECL, CLU_CAST(UI_SetLabelExShadowColor));
	...
	CLU_RegisterFunction("UI_CreateTextItem", "int", "char*, ulint", CLU_CDECL, CLU_CAST(UI_CreateTextItem));
	...
	CLU_RegisterFunction("UI_SetLabelExFont", "int", "int,int,int,ulint", CLU_CDECL, CLU_CAST(UI_SetLabelExFont));
	...
	CLU_RegisterFunction("UI_SetHeadSayBkgColor", "int", "ulint", CLU_CDECL, CLU_CAST(UI_SetHeadSayBkgColor));

	CLU_RegisterFunction("UI_SetTitleFont", "int", "int, int, ulint, int", CLU_CDECL, CLU_CAST(UI_SetTitleFont));
