...
void	CSMallMap2D::InitScene()
{
	...
	mi.subset_num = 1;
	mi.vertex_num = 4;
	mi.vertex_seq = LE_NEW(drVector3[mi.vertex_num]);
	mi.blend_seq =  LE_NEW(drBlendInfo[mi.vertex_num]);
	mi.vercol_seq = LE_NEW(DWORD[mi.vertex_num]);
	mi.texcoord0_seq = LE_NEW(drVector2[mi.vertex_num]);
	mi.texcoord1_seq = LE_NEW(drVector2[mi.vertex_num]);
    mi.subset_seq = DR_NEW(drSubsetInfo[mi.subset_num]);

	mi.vertex_seq[0] = drVector3(0, 0,  0);
	mi.vertex_seq[1] = drVector3(0, 0,  0);
	mi.vertex_seq[2] = drVector3(0, 0,  0);
	mi.vertex_seq[3] = drVector3(0, 0,  0);
	...
	mi.texcoord0_seq[0] = drVector2(0,0);
	mi.texcoord0_seq[1] = drVector2(1,0);
	mi.texcoord0_seq[2] = drVector2(1,1);
	mi.texcoord0_seq[3] = drVector2(0,1);

	mi.texcoord1_seq[0] = drVector2(0,0);
	mi.texcoord1_seq[1] = drVector2(1,0);
	mi.texcoord1_seq[2] = drVector2(1,1);
	mi.texcoord1_seq[3] = drVector2(0,1);
	...
	mi.vertex_seq[0] = drVector3(float(_rcWnd.left),float(_rcWnd.top),0.9f);
	mi.vertex_seq[1] = drVector3(float(_rcWnd.right),float(_rcWnd.top),0.9f);
	mi.vertex_seq[2] = drVector3(float(_rcWnd.right),float(_rcWnd.bottom),0.9f);
	mi.vertex_seq[3] = drVector3(float(_rcWnd.left),float(_rcWnd.bottom),0.9f);
