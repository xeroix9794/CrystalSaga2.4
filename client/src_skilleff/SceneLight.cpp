...
int AnimCtrlLight::UpdateObject(SceneLight* ret_obj)
{
    ...
    ret_obj->type = u->type;
    LEVector3Slerp((drVector3*)&ret_obj->pos, (drVector3*)&u->pos, (drVector3*)&v->pos, t);
    LEVector3Slerp((drVector3*)&ret_obj->amb.r, (drVector3*)&u->amb.r, (drVector3*)&v->amb.r, t);
    LEVector3Slerp((drVector3*)&ret_obj->dif.r, (drVector3*)&u->dif.r, (drVector3*)&v->dif.r, t);
