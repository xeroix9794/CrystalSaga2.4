...
// Add by lark.li 20081118 begin
#define ERR_OS_BASE         2500                //M(o)nitorServer->(S)erver返回的错误码空间2500－3000
// End
...
#define ERR_AP_PBANUSER      ERR_AP_BASE + 7     //个人密保卡帐号
#define ERR_AP_SBANUSER		ERR_AP_BASE + 8		//刷屏GM封停
// End
...
#define ERR_PT_BANUSER      ERR_PT_BASE + 35     //官方封停帐号
#define ERR_PT_PBANUSER     ERR_PT_BASE + 36     //个人密保卡帐号
// End
#define ERR_PT_HASCRYSTALTRADE ERR_PT_BASE + 37	 //角色有水晶挂单Add by sunny.sun 20090603
...
// Add by lark.li 20080825 begin
#define ERR_MC_BANUSER      ERR_MC_BASE + 10     //官方封停帐号
#define ERR_MC_PBANUSER     ERR_MC_BASE + 11     //个人密保卡帐号
// End
...
#define ERR_OS_NOTMATCH_VERSION	ERR_OS_BASE + 1		// 不匹配版本
#define ERR_OS_RELOGIN	ERR_OS_BASE + 2		// 双重登录
// End
