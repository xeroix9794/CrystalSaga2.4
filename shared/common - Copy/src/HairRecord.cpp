...
{   
	...
	//_tcsncpy(pInfo->szColor, ConvertResString(ParamList[m++].c_str()), sizeof(pInfo->szColor) );
	_tcsncpy_s(pInfo->szColor, sizeof(pInfo->szColor), ConvertResString(ParamList[m++].c_str()) ,_TRUNCATE);
	// End
