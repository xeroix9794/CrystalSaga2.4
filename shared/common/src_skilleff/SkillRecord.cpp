...
{   
	...
	strncpy_s(pInfo->szPrepare, sizeof(pInfo->szPrepare), ParamList[m++].c_str(), _TRUNCATE);
	...
	strncpy_s(pInfo->szRangeState, sizeof(pInfo->szRangeState), ParamList[m++].c_str(), _TRUNCATE);
	...
	strncpy_s(pInfo->szUseSP, sizeof(pInfo->szUseSP), ParamList[m++].c_str(), _TRUNCATE);
	//pInfo->szUseSP[defSKILL_EFFECT_SCRIPT_LEN - 1] = _TEXT('\0');

	// 消耗“耐久度“公式
	//strncpy(pInfo->szUseEndure, ParamList[m++].c_str(), defSKILL_EFFECT_SCRIPT_LEN);
	strncpy_s(pInfo->szUseEndure, sizeof(pInfo->szUseEndure), ParamList[m++].c_str(), _TRUNCATE);
	...
	strncpy_s(pInfo->szUseEnergy, sizeof(pInfo->szUseEnergy), ParamList[m++].c_str(), _TRUNCATE);
	...
	strncpy_s(pInfo->szFireSpeed, sizeof(pInfo->szFireSpeed), ParamList[m++].c_str(), _TRUNCATE);
	...
	// 描述
	// Modify by lark.li 20080725 begin
	...
	//strncpy( pInfo->szDescribeHint, ConvertResString(ParamList[m++].c_str()), sizeof(pInfo->szDescribeHint) );
	strncpy_s( pInfo->szDescribeHint, sizeof(pInfo->szDescribeHint), ConvertResString(ParamList[m++].c_str()), _TRUNCATE );
	// End
	...
	//strncpy( pInfo->szEffectHint, ConvertResString(ParamList[m++].c_str()), sizeof(pInfo->szEffectHint) );
	strncpy_s( pInfo->szEffectHint, sizeof(pInfo->szEffectHint), ConvertResString(ParamList[m++].c_str()), _TRUNCATE );
	// End
	...
	//strncpy( pInfo->szExpendHint, ConvertResString(ParamList[m++].c_str()), sizeof(pInfo->szExpendHint) );
	strncpy_s( pInfo->szExpendHint, sizeof(pInfo->szExpendHint), ConvertResString(ParamList[m++].c_str()), _TRUNCATE );
	// End
	return TRUE;
}
