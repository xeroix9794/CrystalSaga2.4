...
#ifdef _NOSERVER //这个是否适用Server需要测试
 	if( m_isclose || m_head==NULL )
 		return NULL;
#endif
...
/*-----------------------------------------------------------------------
  客户端的封包测试 Add by Waiting 2009-06-18
  测试结果：每次看见新玩家时，总要处理个几百毫秒，造成画面停顿
  改进方向：1.继续缩短创建人物需要的时间 2.考虑另开线程创建人物对象
-----------------------------------------------------------------------*/
