...
public:
	...
	static void dump() { 
		std::cout << "instance = " << hex << instance_ << std::endl; 
	}
...
// this version of the singleton implementation will soon be discarded because it can not be easily extended to multithreaded security
// it is not recommended to use this singleton template
#if 1
template <class T>
class CSingleton {
protected:
