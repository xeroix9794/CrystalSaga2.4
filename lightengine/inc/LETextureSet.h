...
protected:
	...
	static LETexSet* _Instance; // 相当于单键, 把自己记住
...
#define USE_MANAGED_TEXTURE
	...
	virtual void  _DeleteRawData(CRawDataInfo *pInfo)
	{
		...
		drITex* pTex = (drITex*)pInfo->pData;
#else
...
inline LETexInfo* GetTextureInfo(int nID) // 通过ID取得Texture描述信息
{
	if (LETexSet::I() != NULL)
	{
...
{
	if (LETexSet::I()->IsEnablePack() == FALSE) // 非打包方式下
	{
