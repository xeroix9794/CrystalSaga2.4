	...
	TCHAR* pcDirectXVersionLetter)
{
	...
	if (GetSystemDirectory(szPath, MAX_PATH) != 0)
	{
		...
		_tcsncpy_s(szFile, szPath, _TRUNCATE);
		_tcscat_s(szFile, TEXT("\\ddraw.dll"));
		...
		_tcsncpy_s(szFile, szPath, _TRUNCATE);
		_tcscat_s(szFile, TEXT("\\d3drg8x.dll"));
		if (SUCCEEDED(GetFileVersion(szFile, &llFileVersion)))
		{
		...
		_tcsncpy_s(szFile, szPath, _TRUNCATE);
		_tcscat_s(szFile, TEXT("\\dplayx.dll"));
		if (SUCCEEDED(GetFileVersion(szFile, &llFileVersion)))
		{
		...
		_tcsncpy_s(szFile, szPath, _TRUNCATE);
		_tcscat_s(szFile, TEXT("\\dinput.dll"));
		if (SUCCEEDED(GetFileVersion(szFile, &llFileVersion)))
		{
		...
		_tcsncpy_s(szFile, szPath, _TRUNCATE);
		_tcscat_s(szFile, TEXT("\\d3d8.dll"));
		if (SUCCEEDED(GetFileVersion(szFile, &llFileVersion)))
		{
		...
		_tcsncpy_s(szFile, szPath, _TRUNCATE);
		_tcscat_s(szFile, TEXT("\\mpg2splt.ax"));
		if (SUCCEEDED(GetFileVersion(szFile, &llFileVersion)))
		{
		...
		_tcsncpy_s(szFile, szPath, _TRUNCATE);
		_tcscat_s(szFile, TEXT("\\dpnet.dll"));
		if (SUCCEEDED(GetFileVersion(szFile, &llFileVersion)))
		{
		...
		_tcsncpy_s(szFile, szPath, _TRUNCATE);
		_tcscat_s(szFile, TEXT("\\d3d9.dll"));
		if (SUCCEEDED(GetFileVersion(szFile, &llFileVersion)))
		{
...
//drSystemInfo
DR_STD_ILELEMENTATION(drSystemInfo)

drSystemInfo::drSystemInfo()
{
...
DR_RESULT drSystemInfo::CheckDirectXVersion()
{
...
DWORD drSystemInfo::GetDirectXVersion()
{
